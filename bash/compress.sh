...
#ssh root@47.95.6.138 "mv zhlive-home /opt/www/home"
 ...
 mv dist zhlive-home && tar zcvf zhlive-home.tar.gz zhlive-home && mv zhlive-home dist && mv zhlive-home.tar.gz dist/
scp dist/zhlive-home.tar.gz root@39.108.247.80:/opt
ssh root@39.108.247.80 "rm -rf /opt/www/home && tar -zxvf /opt/zhlive-home.tar.gz"
ssh root@39.108.247.80 "mv zhlive-home /opt/www/home"
