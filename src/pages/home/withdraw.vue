<template>
    <div class="withdraw">
        ...
        <div class="row own-hb">
            <p class="num">
                <input style="padding: 3px;min-height: 34px" type="number" :placeholder="0" v-model="withdraw.soulBean" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"
