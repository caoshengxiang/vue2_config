    ...
    <div>
        ...
        <div class="login">
            ...
            <div class="connect-btn">
                <a id="qqLoginBtn" class="btn" href="http://ddzs.cxria.com/api/thirdpartylogin/index?loginType=QQ"><img
                    src="../../assets/qq.png" alt=""></a>
                <a id="wx_connect_btn" class="btn weixin-login" href="http://ddzs.cxria.com/api/thirdpartylogin/index?loginType=WECHATPUB"><img
                    src="../../assets/weixin.png" alt=""></a>
                <a id="wb_connect_btn" href="http://ddzs.cxria.com/api/thirdpartylogin/index?loginType=WEIBO"><img
