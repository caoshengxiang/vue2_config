...
.m-colorPicker{
  ...
  input{ display: none; }
  .colorBtn{ width: 24px; height: 5px; }
  .colorBtn.disabled{ cursor: no-drop; }
  .box{
      z-index: 199;
    position: absolute;
      bottom: 30px;
      width: 190px; background: #fff; border: 1px solid #ddd; visibility: hidden; border-radius: 2px; margin-top: 2px; padding: 10px; padding-bottom: 5px; box-shadow: 0 0 5px rgba(0,0,0,.15); opacity: 0; transition: all .3s ease;
